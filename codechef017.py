...
The professor decided to create NN groups of 22 students each. The groups were created as follows: the first group consists of roll numbers 1 and 2N, the second group of roll numbers 2 and 2N−1, and so on, with the final group consisting of roll numbers N and N+1.
...
for _ in range(int(input())):
    ...
    if n==x:
        ...
        print(2*n - (x-1)) # mathematical operation logic